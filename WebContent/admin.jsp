...
<body
	...
	<h1>
		<p align="center" style="margin-top: 10%; color: rgb(25, 25, 25)">Admin
			Page</p>
	</h1>
	...
	<table align="center" style="border: transparent; margin-bottom: 0px">
		<tr style="border: transparent">
			...
			<td>&nbsp</td>
			<td><a href="admin.jsp"
				style="text-decoration: none; color: rgb(25, 25, 25)">admin</a></td>
		</tr>
	</table>
		...
		<form action="AdminLoginServlet" method="post">
			...
			<p>
				<input type="password" name="password"
					style="width: 200px; height: 30px" placeholder=" Password">
			</p>
			<p>
